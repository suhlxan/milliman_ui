// components/navbar/StopButton.tsx
 ...
 * ----------------------------------------------------------------------------
 * Displays a STOP button and animated loading icon. Meant to interrupt or
 * cancel long-running operations. Designed for right side of NavBar.
 */
const StopButton: React.FC<StopButtonProps> = ({ onStop }) => {
  return (
    <>
      {/* Loading animation icon (white spinner) */}
      <img
        ...
        style={{
          height: '28px',
          marginRight: '8px',
          filter: 'brightness(0) invert(1)', // converts dark to light
        }}
      />
